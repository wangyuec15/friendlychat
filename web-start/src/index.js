...
function authStateObserver(user) {
  if (user) {
    ...
    userPicElement.innerHTML = '<img src=' + addSizeToGoogleProfilePic(profilePicUrl)+ ' referrerpolicy="no-referrer" style="display: none;"/>';
...
var userContainerElement = document.getElementById('user-container');
